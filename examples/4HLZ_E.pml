...
select interface, resi  and chain E
color gray40, interface
show spheres, interface
color green, antibody_chains
delete antibody_chains

select paleyellow_residues, resi 31+28 and chain E
color paleyellow, paleyellow_residues
select yelloworange_residues, resi 128 and chain E
